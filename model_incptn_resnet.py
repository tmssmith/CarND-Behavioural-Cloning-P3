...
incptn_res = InceptionResNetV2(weights=weights_flag, include_top=False, input_shape=(224,224,3), pooling='avg')

if freeze_flag == True:
    for layer in incptn_res.layers:
...
model.save('model_incptn_res.h5')
